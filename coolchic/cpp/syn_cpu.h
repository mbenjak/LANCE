...
template <typename P>
void custom_conv_ks1_inX_outX(int KS, P *kw, P *kb, int h_in, int w_in, int stride_in, int plane_stride_in, int residue_origin_offset, int N_IN, P *in, int N_OUT, P *out, int residue, int relu);
template <typename P>
void custom_conv_ksX_inX_outX(int KS, P *kw, P *kb, int h_in, int w_in, int stride_in, int plane_stride_in, int residue_origin_offset, int N_IN, P *in, int N_OUT, P *out, int residue, int relu);

template <typename P>
void custom_conv_ks1_inX_hiddenX_outX(int KS, P *kw7_40, P *kb40, P *kw40_3, P *kb3, int h_in, int w_in, int pad_in, int plane_stride_in, int N_IN, int N_HIDDEN, P *in, int N_OUT, P *out);

template <typename P>
void custom_conv_ks3_inX_outX_lb(int KS, P *kw, P *kb, int h_in, int w_in, int stride_in, int plane_stride_in, int residue_origin_offset, int N_IN, P *in, int N_OUT, P *out, P *line_buffer, int residue, int relu);
template <typename P>
